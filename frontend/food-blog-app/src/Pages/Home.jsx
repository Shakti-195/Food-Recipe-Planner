    ...
    return (
        <>
            <section className='home'>
                <div className='left'>
                    <h1>Food Recipe</h1>
                    <h5>Explore, create, and share amazing recipes with food enthusiasts. From quick
                        snacks to healthy meals and special desserts, find recipes that suit every
                        occasion and inspire your next cooking adventure.</h5>
                    <button onClick={addRecipe}>Share your recipe</button>
                </div>
                <div className='right'>
                    <img src={foodRecipe} width="320px" height="300px"  style={{
    width: "430px",
    height: "420px",
    objectFit: "cover",
    borderRadius: "20px",
